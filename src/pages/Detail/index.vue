            ...
            <div class="chooseArea">
              ...
              <dl v-for="item in spuSaleAttrList" :key="item.id">
                ...
                <dd
                  ...
                  :key="item1.id"
                  @click="changeIschecked(item.spuSaleAttrValueList, item1)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input
                  ...
                  class="itxt"
                  v-model="skuNum"
                  @change="skuNum > 1 ? (skuNum = skuNum) : (skuNum = 1)"
                />
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a
                  href="javascript:"
                  class="mins"
                  @click="skuNum < 2 ? 1 : skuNum--"
                  >-</a
                >
              </div>
              <div class="add">
  ...
  methods: {
    ...
    async addShopCart() {
      try {
        ...
        alert("添加购物车成功!");
        //添加成功后就将商品信息存储到localstorage中 商品数量存在$route的query参数中传过去
